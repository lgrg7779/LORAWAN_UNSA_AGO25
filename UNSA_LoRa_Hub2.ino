...
String appEui = "0000000000000000"; // Add your own AppEUI
String appKey = "f9a50c00e4321b1c1454c8a30dc9076d"; //dev eui a8610a3339278e11
...
void loop() {
  ...
  delay(10000); // Time between packets 28725lgrg
  ...
  delay(10000); // Time between packets 29725lgrg
